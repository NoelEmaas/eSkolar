    ...
    <div class="container">
        <div class="col row g-3 mt-5 pt-4">
            <div class="col-sm input-group input-group-lg border border-0">
                <input id="searchScholarshipBar" type="text" class="form-control border border-0" aria-describedby="inputGroup-sizing-lg" name="q" placeholder="Search Scholarship" style="font-size: 14px; box-shadow: none; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                <span class="input-group-text px-4 py-3 border border-0 bg-blue" id="searchScholarshipButton" role="button" style="font-size: 14px; color: white; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                    Search
                </span>
            </div>
