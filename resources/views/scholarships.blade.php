        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body px-xxl-5 px-xl-5 px-lg-5 px-md-5 px-2 pb-4">
                    <form>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Benefactor</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                                placeholder="CHED">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputPassword1" class="form-label">Scholarship Program</label>
                            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Ched Scholarship Program 2021">
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="row" id="inputAmount">
                                <div class="input-group col">
                                    ...
                                    <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="30000">
                                ...
                                <div class="input-group col">
                                    <span class="input-group-text">₱</span>
                                    <input type="number" class="form-control" aria-label="Amount (to the nearest dollar)" placeholder="60000">
                                    <span class="input-group-text">.00</span>
                                </div>
                            </div>
                        </div>
                        <div class="mb-5">
                            <label for="exampleInputPassword1" class="form-label">Scholarship Information</label>
