    ...
    <div class="modal-dialog modal-dialog-centered">
        @if(Auth::check())
            <div class="modal-content">
                ...
                <form action="{{ route('addScholarship') }}" method="POST">
                    @csrf
                    <div class="modal-body px-4 pb-4">
                        <div class="mb-3">
                            <label for="inputBenefactor" class="form-label">Benefactor</label>
                            <input type="text" class="form-control" name="benefactor" aria-describedby="emailHelp"
                                placeholder="CHED">
                        </div>
                        <div class="mb-3">
                            <label for="inputProgram" class="form-label">Scholarship Program</label>
                            <input type="text" class="form-control" name="program" placeholder="Ched Scholarship Program 2021">
                        </div>
                        <div class="mb-3">
