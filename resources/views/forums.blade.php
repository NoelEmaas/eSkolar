    ...
    <div class="container">
        <div class="row g-3 mt-5 pt-4">
            ...
            <div class="col-xxl-auto col-xl-auto col-lg-auto col-md-auto col-sm-auto col-12">
                <button class="btn-add-post btn btn-primary border border-0" style="width: 100%; height: 100%; box-shadow: 0px 0px 5px rgb(203, 209, 214);" data-bs-toggle="modal" data-bs-target="#createPostModal">Start Forum <i class="bi bi-chat-square-dots ps-2"></i></button> 
            </div>
        </div>
    </div>
</div>
...
<div class="container mt-4">
    <div class="row">
        ...
        @foreach ($forums as $forum)
            <a href="{{ route('getForum', ['forum_id' => $forum->id]) }}">
